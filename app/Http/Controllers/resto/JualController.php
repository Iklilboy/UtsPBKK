...
return redirect('/resto/home') ->withErrors(['msg' => $e->getMessage()]); 
} 
return redirect('/resto/home') ->with('success', 'Berhasil ubah status order menjadi PROSES'); 
}
...
return redirect('/resto/home') ->with('success', 'Berhasil ubah status order menjadi SIAP'); 
}
...
return redirect('/resto/home') ->with('success', 'Berhasil membatalkan order'); 
}
...
return redirect('/resto/home') ->withErrors(['msg' => 'Kode tracking tidak dikenal']); 
} 
