...
return redirect('/kurir/home') ->withErrors(['msg' => $e->getMessage()]); 
} 
return redirect('/kurir/home') ->with('success', 'Berhasil ubah status order menjadi ANTAR'); 
}
...
return redirect('/kurir/home') ->with('success', 'Berhasil ubah status order menjadi TIBA'); 
}
...
return redirect('/kurir/home') ->with('success', 'Berhasil beri rating konsumen'); 
}
}
