...
public function index()
{
    ...
    $order_hari_ini = Jual::whereRaw("konsumen_id=? AND status_jual='TIBA' 
    AND waktu_pesan>=? AND waktu_pesan<?", [auth()->user()->id,  
    Carbon::today()->subDays(1), Carbon::today()->addDays(1)])->count(); 
    return view('konsumen.home.index', compact('jual', 'rating_5','rating_semua' 
    ,'order_minggu_terakhir','order_bulan_ini','order_hari_ini'));
}   
}
