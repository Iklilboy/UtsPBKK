...
[App\Http\Controllers\resto\UserController::class, 'index']) ->middleware('can:isResto'); 
Route::get('resto/user/create',  
[App\Http\Controllers\resto\UserController::class, 'create']) ->middleware('can:isResto'); 
Route::post('resto/user/store',  
[App\Http\Controllers\resto\UserController::class, 'store']) ->middleware('can:isResto'); 
Route::get('resto/user/edit/{id}',  
[App\Http\Controllers\resto\UserController::class, 'edit']) ->middleware('can:isResto'); 
Route::post('resto/user/update/{id}',  
[App\Http\Controllers\resto\UserController::class, 'update']) ->middleware('can:isResto'); 
Route::post('resto/user/destroy/{id}',  
[App\Http\Controllers\resto\UserController::class, 'destroy']) ->middleware('can:isResto');
...
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'index']) ->middleware('can:isKonsumen'); 
Route::get('konsumen/alamatkirim/create', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'create']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/alamatkirim/store', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'store']) ->middleware('can:isKonsumen'); 
Route::get('konsumen/alamatkirim/edit/{id}', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'edit']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/alamatkirim/update/{id}', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'update']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/alamatkirim/destroy/{id}', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'destroy']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/alamatkirim/default/{id}', 
[App\Http\Controllers\konsumen\AlamatKirimController::class, 'default']) ->middleware('can:isKonsumen');

Route::get('konsumen/order',  
[App\Http\Controllers\konsumen\JualController::class, 'order']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/addtocart/{id}',  
[App\Http\Controllers\konsumen\JualController::class, 'addtocart']) ->middleware('can:isKonsumen'); 
Route::get('konsumen/cart',  
[App\Http\Controllers\konsumen\JualController::class, 'getcart']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/cart',  
[App\Http\Controllers\konsumen\JualController::class, 'postcart']) ->middleware('can:isKonsumen'); 
Route::get('konsumen/checkout',  
[App\Http\Controllers\konsumen\JualController::class, 'getcheckout']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/checkout',  
[App\Http\Controllers\konsumen\JualController::class, 'postcheckout']) ->middleware('can:isKonsumen'); 
Route::post('konsumen/cancel/{id}',  
[App\Http\Controllers\konsumen\JualController::class, 'postcancel']) ->middleware('can:isKonsumen'); 
Route::get('konsumen/track/{id}',  
[App\Http\Controllers\konsumen\JualController::class, 'gettrack']) ->middleware('can:isKonsumen');
...
[App\Http\Controllers\konsumen\JualController::class, 'postrate']) ->middleware('can:isKonsumen'); 
...
[App\Http\Controllers\resto\PizzaController::class, 'getimage']) ->middleware('can:isResto'); 
Route::post('resto/pizza/image/{id}',  
[App\Http\Controllers\resto\PizzaController::class, 'postimage']) ->middleware('can:isResto'); 
